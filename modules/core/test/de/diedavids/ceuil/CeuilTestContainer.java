...
public class CeuilTestContainer extends TestContainer {

    public CeuilTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/ceuil/app.properties",
    ...
    public static class Common extends CeuilTestContainer {

        public static final CeuilTestContainer.Common INSTANCE = new CeuilTestContainer.Common();
